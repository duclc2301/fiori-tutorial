		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#sphinxjsccomfioritutorial-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sphinxjsccomfioritutorial-display": {
								"semanticObject": "sphinxjsccomfioritutorial",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sphinxjsc.com.fioritutorial",
									"url": sap.ui.require.toUrl("sphinxjsc/com/fioritutorial")
								}
							}
						}
					}
